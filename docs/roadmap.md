...
Audit responsibilities, dependency direction, interface ownership, and command and response types across the implemented product. Correct the architectural causes before PHS-07 resumes. Corrections 1 through 8 are implemented and verified by the main agent. TUI ownership blockers BLK-01 through BLK-05 are closed. [U7 evidence](specs/features/initial/phases/07.1-architecture-audit-and-correction/solution.md#u7-run-persistence-cause-and-tui-cleanup) records source-backed persistence classification, complete causes, and application cleanup. [U8 implementation and package accounting](specs/features/initial/phases/07.1-architecture-audit-and-correction/u8-evidence.md) include completed main-agent inspection and repeated checks. Review of the corrective commit `b03095a` found FND-12 through FND-14. The [U6 retention revision](specs/features/initial/phases/07.1-architecture-audit-and-correction/solution.md#complete-error-retention-revision) covers operation, writer and connection ownership and compatible provider normalization. The O72-1 [retention correction](specs/features/initial/phases/07.1-architecture-audit-and-correction/solution.md#u6-retention-correction) is committed as `ded1549`. Independent review found FND-15 through FND-17. The user approved the [runtime completion and TUI causality corrections](specs/features/initial/phases/07.1-architecture-audit-and-correction/solution.md#qst-05-runtime-completion-meaning-and-tui-submission-causality). The [TUI causality correction](specs/features/initial/phases/07.1-architecture-audit-and-correction/solution.md#u5-causality-verification) has implementation and main-agent verification evidence. The [runtime completion correction](specs/features/initial/phases/07.1-architecture-audit-and-correction/solution.md#u6-runtime-completion-evidence) has implementation and main-agent verification evidence. Review of `cb3a8f6` found FND-18 through FND-20; O74-1 includes FND-21. The [producer correction](specs/features/initial/phases/07.1-architecture-audit-and-correction/solution.md#u6-producer-preservation) has implementation and main-agent verification evidence. The separate [FND-22 process correction](specs/features/initial/phases/07.1-architecture-audit-and-correction/solution.md#process-cancellation-evidence) has implementation and main-agent verification evidence under O76-1 and O77-1. The [FND-23 dispatch-confirmation correction](specs/features/initial/phases/07.1-architecture-audit-and-correction/solution.md#host-command-dispatch-confirmation-correction) has implementation and main-agent verification evidence under O78-1. The [U8 smoke-fixture correction](specs/features/initial/phases/07.1-architecture-audit-and-correction/u8-evidence.md#smoke-fixture-correction) has implementation and main-agent verification evidence. The [remaining corrections](specs/features/initial/phases/07.1-architecture-audit-and-correction/remaining-corrections-solution.md) align the implemented one-attempt model-execution owner, error paths, implicit-root session state, and connection cleanup. Documentation alignment is complete. Required verification, independent review, and explicit final acceptance remain pending.
...
- [Remaining-corrections technical solution](specs/features/initial/phases/07.1-architecture-audit-and-correction/remaining-corrections-solution.md)
