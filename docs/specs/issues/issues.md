...
- [ ] Agent run failure semantics: `docs/specs/issues/agent-run-failure-semantics`
  ...
  - [X] Source-backed history-persistence failure distinction for both client contracts, verified in PHS-07.1 U7: `docs/specs/features/initial/phases/07.1-architecture-audit-and-correction/solution.md`
    - PHS-07.1 remains blocked after integrated-review findings FND-10/FND-11. Their bounded U6 correction awaits independent acceptance; user acceptance remains pending: `docs/specs/features/initial/phases/07.1-architecture-audit-and-correction/solution.md#u6-follow-up-complete-source-and-delivery-causes`
