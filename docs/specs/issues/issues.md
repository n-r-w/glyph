...
- [ ] Agent run failure semantics: `docs/specs/issues/agent-run-failure-semantics`
  - [X] Shared `Failed.code` transport and implemented `RUN-F = INTERNAL` baseline: `docs/specs/issues/blocking-contract-operation-processing/solution.md`
  - [ ] Approved history-persistence failure distinction for both client contracts, implementation pending in PHS-07.1: `docs/specs/features/initial/phases/07.1-architecture-audit-and-correction/solution.md`
