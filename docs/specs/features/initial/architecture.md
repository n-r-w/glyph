...
- REF-02: `docs/specs/features/initial/delivery-plan/index.md` defines delivery ownership and order.
- REF-03: `docs/specs/features/initial/prototype-technical-solution.md` records the implemented prototype baseline, not target ownership.
