...
| FND-05 | [U6 source traces and regressions](solution.md#u6-complete-error-text) cover SDK diagnostics, Codex HTTP 401, navigation validation, and unknown labels. U8 changes no error behavior. The [follow-up correction](solution.md#u6-follow-up-complete-source-and-delivery-causes) addresses FND-10/FND-11. FND-12 through FND-14 have [retention implementation and local check evidence](solution.md#u6-retention-correction), pending independent review. Whole-product error closure remains blocked. |
