...
Whole-product acceptance remains blocked by [FND-22](audit.md#fnd-22-bash-group-cancellation-can-leave-a-child-running). The descendant timeout is not a fixture-only exclusion. O75-1 authorizes completing this error-preservation commit first, then agreeing a separate process-lifetime solution before implementation. No termination correction is included here.
