...
- REF-03: [ticket order and ownership](index.md) - delivery order and dependencies.
- REF-04: [PHS-03](03-providers-models-runtime-selection.md) - existing provider-neutral model catalogue and selection behavior.
