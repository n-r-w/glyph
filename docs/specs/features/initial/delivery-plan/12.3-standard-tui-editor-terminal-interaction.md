...
- FRQ-09: Expose direct shell execution with model-visible-output and model-hidden-output outcomes.
...
- DLV-01: Multiline editor, history, completion, attachments, clipboard, external-editor, direct-shell, and queued-input presentation.
...
- ACC-05: Direct shell execution covers both model-visible-output and model-hidden-output outcomes.
...
- RSK-02: External editor or shell child processes can leave terminal modes active. Suspend application modes before child execution and restore them after child exit.
