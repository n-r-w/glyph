...
- FRQ-15: Disable alternate screen, mouse reporting, bracketed paste, focus reporting, and application keyboard modes after normal exit, UI process failure, and Host termination.
...
- ACC-07: Suspension, normal exit, UI failure, and Host termination leave all application-owned terminal modes disabled.
