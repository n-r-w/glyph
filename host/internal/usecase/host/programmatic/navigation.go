...
//go:generate go tool mockgen -source=navigation.go -destination=navigation_mock.go -package=programmatic
...
const (
	// navigationModelUnavailable identifies missing summary model configuration.
	navigationModelUnavailable = "MODEL_UNAVAILABLE"
	// navigationAuthUnavailable identifies unavailable summary credentials.
	navigationAuthUnavailable = "CREDENTIAL_UNAVAILABLE"
	// navigationModelFailed identifies failed summary generation.
	navigationModelFailed = "MODEL_FAILED"
	// navigationExtensionInvalidResult identifies invalid final handler state.
	navigationExtensionInvalidResult = "EXTENSION_INVALID_RESULT"
	// navigationExtensionUnavailable identifies failed extension invocation.
	navigationExtensionUnavailable = "EXTENSION_UNAVAILABLE"
)
