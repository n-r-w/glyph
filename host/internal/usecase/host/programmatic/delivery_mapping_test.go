...
func TestDeliveryMapsEveryAgentEvent(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			event: testRunEvent(run.EventToolCallStart, mo.Some(0), mo.None[model.Content](), mo.None[model.Response](), mo.Some(model.ToolCallPreview{
				CallID:      "call",
				Name:        "tool",
				Position:    5,
				Provisional: true,
			...
			}), mo.None[model.ToolCall](), mo.None[tool.Progress](), mo.None[agent.ToolResult](), mo.None[run.TurnSummary](), mo.None[run.AgentSummary]()),
			expected: testAgentEvent(controller.AgentEventToolCallStart, mo.None[controller.ModelContent](), mo.Some(controller.ToolCallPreview{
				CallID:      "call",
				Name:        "tool",
				Position:    5,
				Provisional: true,
			...
			}), mo.None[controller.FinalToolCall](), mo.None[controller.ToolExecution](), mo.None[controller.ToolProgress](), mo.None[controller.ToolResult](), mo.None[controller.ModelResponse](), mo.None[controller.TurnSummary](), mo.None[controller.AgentSummary]()),
		},
		{
			name: "tool call delta",
			event: testRunEvent(run.EventToolCallDelta, mo.Some(0), mo.None[model.Content](), mo.None[model.Response](), mo.Some(model.ToolCallPreview{
				CallID:      "call",
				Name:        "tool",
				Position:    5,
				Provisional: true,
			...
			expected: testAgentEvent(controller.AgentEventToolCallDelta, mo.None[controller.ModelContent](), mo.Some(controller.ToolCallPreview{
				CallID:      "call",
				Name:        "tool",
				Position:    5,
				Provisional: true,
		...
		{
			name: "tool call end",
			event: testRunEvent(run.EventToolCallEnd, mo.Some(5), mo.None[model.Content](), mo.None[model.Response](), mo.None[model.ToolCallPreview](), mo.Some(model.ToolCall{
				ID:        "call",
				Name:      "tool",
				Arguments: map[string]any{"arg": "value"},
			}), mo.None[tool.Progress](), mo.None[agent.ToolResult](), mo.None[run.TurnSummary](), mo.None[run.AgentSummary]()),
			expected: testAgentEvent(controller.AgentEventToolCallEnd, mo.None[controller.ModelContent](), mo.None[controller.ToolCallPreview](), mo.Some(controller.FinalToolCall{
				CallID:    "call",
				Name:      "tool",
				Position:  5,
				Arguments: map[string]any{"arg": "value"},
			}), mo.None[controller.ToolExecution](), mo.None[controller.ToolProgress](), mo.None[controller.ToolResult](), mo.None[controller.ModelResponse](), mo.None[controller.TurnSummary](), mo.None[controller.AgentSummary]()),
		},
		{
			name:     "message end",
			event:    testRunEvent(run.EventMessageEnd, mo.None[int](), mo.None[model.Content](), mo.Some(response), mo.None[model.ToolCallPreview](), mo.None[model.ToolCall](), mo.None[tool.Progress](), mo.None[agent.ToolResult](), mo.None[run.TurnSummary](), mo.None[run.AgentSummary]()),
			expected: testAgentEvent(controller.AgentEventMessageEnd, mo.None[controller.ModelContent](), mo.None[controller.ToolCallPreview](), mo.None[controller.FinalToolCall](), mo.None[controller.ToolExecution](), mo.None[controller.ToolProgress](), mo.None[controller.ToolResult](), mo.Some(mappedResponse), mo.None[controller.TurnSummary](), mo.None[controller.AgentSummary]()),
		},
		{
			name: "tool execution start",
			event: testRunEvent(run.EventToolExecutionStart, mo.None[int](), mo.None[model.Content](), mo.None[model.Response](), mo.None[model.ToolCallPreview](), mo.Some(model.ToolCall{
				Arguments: nil,
				ID:        "call",
				Name:      "tool",
			}), mo.None[tool.Progress](), mo.None[agent.ToolResult](), mo.None[run.TurnSummary](), mo.None[run.AgentSummary]()),
			expected: testAgentEvent(controller.AgentEventToolExecutionStart, mo.None[controller.ModelContent](), mo.None[controller.ToolCallPreview](), mo.None[controller.FinalToolCall](), mo.Some(controller.ToolExecution{
				CallID:   "call",
				ToolName: "tool",
			}), mo.None[controller.ToolProgress](), mo.None[controller.ToolResult](), mo.None[controller.ModelResponse](), mo.None[controller.TurnSummary](), mo.None[controller.AgentSummary]()),
		},
		{
			name: "tool execution update",
			event: testRunEvent(run.EventToolExecutionUpdate, mo.None[int](), mo.None[model.Content](), mo.None[model.Response](), mo.None[model.ToolCallPreview](), mo.None[model.ToolCall](), mo.Some(tool.Progress{
				Channel: tool.ProgressChannelStdout,
				Content: "line",
			}), mo.None[agent.ToolResult](), mo.None[run.TurnSummary](), mo.None[run.AgentSummary]()),
			expected: testAgentEvent(controller.AgentEventToolExecutionUpdate, mo.None[controller.ModelContent](), mo.None[controller.ToolCallPreview](), mo.None[controller.FinalToolCall](), mo.None[controller.ToolExecution](), mo.Some(controller.ToolProgress{
				Channel: controller.ProgressChannelStdout,
				Content: "line",
			}), mo.None[controller.ToolResult](), mo.None[controller.ModelResponse](), mo.None[controller.TurnSummary](), mo.None[controller.AgentSummary]()),
		},
		{
		...
		{
			name: "turn end",
			event: testRunEvent(run.EventTurnEnd, mo.None[int](), mo.None[model.Content](), mo.None[model.Response](), mo.None[model.ToolCallPreview](), mo.None[model.ToolCall](), mo.None[tool.Progress](), mo.None[agent.ToolResult](), mo.Some(run.TurnSummary{
				Response:    response,
				ToolResults: []agent.ToolResult{toolResult},
			}), mo.None[run.AgentSummary]()),
			expected: testAgentEvent(controller.AgentEventTurnEnd, mo.None[controller.ModelContent](), mo.None[controller.ToolCallPreview](), mo.None[controller.FinalToolCall](), mo.None[controller.ToolExecution](), mo.None[controller.ToolProgress](), mo.None[controller.ToolResult](), mo.None[controller.ModelResponse](), mo.Some(controller.TurnSummary{
		...
		{
			name: "agent end",
			event: testRunEvent(run.EventAgentEnd, mo.None[int](), mo.None[model.Content](), mo.None[model.Response](), mo.None[model.ToolCallPreview](), mo.None[model.ToolCall](), mo.None[tool.Progress](), mo.None[agent.ToolResult](), mo.None[run.TurnSummary](), mo.Some(run.AgentSummary{
				AddedHistory: nil,
				Outcome:      agent.RunOutcomeFailed,
				ErrorMessage: mo.Some("failed"),
			})),
			expected: testAgentEvent(controller.AgentEventAgentEnd, mo.None[controller.ModelContent](), mo.None[controller.ToolCallPreview](), mo.None[controller.FinalToolCall](), mo.None[controller.ToolExecution](), mo.None[controller.ToolProgress](), mo.None[controller.ToolResult](), mo.None[controller.ModelResponse](), mo.None[controller.TurnSummary](), mo.Some(controller.AgentSummary{
