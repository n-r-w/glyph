...
type Service struct {
	...
	// output attaches connection events to the operation writer.
...
func New(applicationContext context.Context, session HostSession, output ConnectionOutput) *Service {
